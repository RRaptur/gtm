...
public class HazmatBoots extends GTMItem {
    public HazmatBoots(String displayName, String itemID, boolean isStackable, boolean isShiny, ItemFactory itemFactory, boolean hasActiveEffect, int durability) {
    ...
    public void onItemStackCreate(NBTItem nbtItem, ItemStack itemStack) {
        LeatherArmorMeta color = (LeatherArmorMeta) itemStack.getItemMeta();
        color.setColor(Color.BLACK);
        itemStack.setItemMeta(color);
