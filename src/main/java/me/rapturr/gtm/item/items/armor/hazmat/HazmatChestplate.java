...
public class HazmatChestplate extends GTMItem {
    public HazmatChestplate(String displayName, String itemID, boolean isStackable, boolean isShiny, ItemFactory itemFactory, boolean hasActiveEffect, int durability) {
